...
const Info = () => {
  return (
    <section className="container mt-4 p-4 bg-light rounded shadow-lg" style={{ backgroundImage: `url(${bgimage})` , backgroundSize: "cover"}}>
      ...
      <p className="fs-6"><strong>📍 Lokasi:<a href="https://bit.ly/3GVp4Xa" target="_blank" rel="noopener noreferrer" className="text-dark">  [Jl. Flamboyan Blok A16 No.24]</a></strong></p>
